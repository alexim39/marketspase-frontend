...
@Component({
  selector: 'app-desktop-promoted-products',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './desktop-promoted-products.component.html',
  styleUrls: ['./desktop-promoted-products.component.scss']
})
export class DesktopPromotedProductsComponent implements OnInit {
