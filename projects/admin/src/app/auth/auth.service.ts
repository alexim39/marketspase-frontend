...
export class AuthService {
 constructor(private apiService: ApiService) {}
  ...
  signIn(formObject: SignInInterface): Observable<any> {
    return this.apiService.post<SignInInterface>(`api/v1/auth/admin/signin`, formObject, undefined, true);
  }
  ...
  signOut(formObject: {}): Observable<any> {
    return this.apiService.post<any>('api/v1/auth/admin/signout', formObject, undefined, true);
  }
