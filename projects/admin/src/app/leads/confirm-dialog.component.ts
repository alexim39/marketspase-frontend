...
@Component({
  ...
  styles: [`
    ...
    mat-dialog-content p { margin: 0 0 0.5rem; font-size: 0.95rem; color: var(--admin-text); }
    mat-dialog-content small { color: var(--admin-text-muted); font-size: 0.82rem; }
...
export class AdminConfirmDialogComponent {
  ...
  readonly ref = inject<MatDialogRef<AdminConfirmDialogComponent, boolean>>(MatDialogRef);
}
